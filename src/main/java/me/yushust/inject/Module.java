 ...
 * annotate it with {@link ProviderMethod}. Annotate the method with
...
public interface Module {
   ...
   * is called before checking for methods annotated with {@literal @}{@link ProviderMethod}
   * to create method-based providers.
   *
   * <p>Don't invoke this method to configure binders. Instead use {@link Binder#install(Module)}
   * to check all the methods annotated with {@literal @}{@link ProviderMethod}</p>
   *
